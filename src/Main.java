...
public class Main extends PApplet
{
    ...
    public void draw()
    {
        ...
        // draw bullseye cursor
        fill(255, 0, 0, 220);    // red outer ring
        ellipse(mouseX, mouseY, 30, 30);
        fill(255, 255, 255, 220); // white middle ring
        ellipse(mouseX, mouseY, 20, 20);
        fill(255, 0, 0, 220);    // red inner ring
        ellipse(mouseX, mouseY, 12, 12);
        fill(255, 255, 255, 220); // white center dot
